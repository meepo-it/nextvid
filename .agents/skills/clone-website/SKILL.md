...
2. Read `@.Codex/skills/clone-website/TARGET.md` for URL and scope. If the URL doesn't match `$ARGUMENTS`, update it.
...
@.Codex/skills/clone-website/TARGET.md
@.Codex/skills/clone-website/INSPECTION_GUIDE.md
