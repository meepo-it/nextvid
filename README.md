...
This repository **does not use GitHub Actions** for build or deploy. There is no CI workflow that ships code on push or merge — deployments are run **manually from your local machine**:
